...
@NgModule({
  ...
  declarations: [ButtonsComponent, FoodPicComponent, NavbarComponent, MainFoodComponent],
  exports: [ ButtonsComponent, FoodPicComponent, NavbarComponent, MainFoodComponent]
})
